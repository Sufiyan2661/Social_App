    ...
    <div className='bg-dark-2 w-full max-w-5xl rounded-[30px] flex-col flex xl:flex-row border border-dark-4 xl:rounded-l-[24px]'>
        <div className="flex justify-between  items-center">
            <div className="flex items-center gap-3">
                ...
                <img src={post?.creator?.imageUrl || '/assets/Icon/profile-placeholder.svg' } alt="creator" className='rounded-full w-12 lg:h-12' />
                </Link>

                <div className="flex flex-col">
                    <p className='text-[16px] font-medium leading-[140%] lg:body-bold text-light-1'>{post.creator.name}</p>
